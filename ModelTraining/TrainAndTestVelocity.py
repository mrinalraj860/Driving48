...
if __name__ == "__main__":
    ...
    from ModelFast import FastPointTransformer
    ...
    train_loader = DataLoader(remapped_train_dataset, batch_size=BATCH_SIZE, shuffle=True, collate_fn=motion_collate_fn, num_workers=2)
    ...
    test_loader = DataLoader(test_dataset, batch_size=BATCH_SIZE, shuffle=False, collate_fn=motion_collate_fn, num_workers=2)
    ...
    # ).to(DEVICE)
    model = FastPointTransformer(num_classes=NUM_CLASSES).to(DEVICE)
